# Ballzcoin Wallet Ðapp

The Ballzcoin wallet, for building with BallzBrowser.

#### Please note: The remainder of this document is included for reference only at this stage. The contents are unchanged from the original Mist / Ethereum repository. 
